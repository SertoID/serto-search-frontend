        ...
        <Flex m="0 auto 80px" maxWidth="720px">
          <Box py={5} px={3}>
            ...
            <ul>
              ...
              <li>
                You have issued your own{" "}
                <Link href="https://beta.schemas.serto.id/schema/serto-organization-profile">
                  organization's profile Verifiable Credential (VC)
                </Link>{" "}
                using Serto Agent. (you will need the JWT code).{" "}
                <Link href="http://beta.search.serto.id/how-it-works">Learn more about how this works</Link>.
              </li>
            </ul>
            <Text mb={5}>
              If you have not completed these steps, you may do so using our Serto Agent tool. You can find Serto Agent
              in the <Link href="https://beta.schemas.serto.id/schema/serto-organization-profile">AWS marketplace</Link>
              . Follow the instructions to launch your own Serto Agent instance.
            </Text>
            <Flex>
